    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <div class="flex items-center space-x-6">
                ...
                <div class="flex-1">
                    <h2 class="text-2xl font-bold text-gray-900"><?php echo htmlspecialchars($employee['name'] ?? 'Unknown'); ?></h2>
                    <p class="text-lg text-gray-600"><?php echo htmlspecialchars($employee['position'] ?? 'N/A'); ?></p>
                    <p class="text-sm text-gray-500"><?php echo htmlspecialchars($employee['department'] ?? 'Unknown'); ?> Department</p>
                    <div class="mt-2 flex items-center space-x-4 text-sm text-gray-600">
                        <span><i class="fas fa-envelope mr-1"></i><?php echo htmlspecialchars($employee['email'] ?? 'No email'); ?></span>
